...
You can use it by compressing this [Gerber](GERBER_GH_DIY) folder and uploading it to JLCPCB as it is.<BR><BR>
Feb 24 2024, Updated PCB files. Includes router error fixes, please check this [V.1.4](GERBER_GH_DIY_1.4)
...
- It is known that the Grappler Minus card does not work with MFA2 WorkShop's WDrive due to timing issues. This is because there was a router error in one place, but it can be easily fixed. In addition, it works normally with SPIISD. It will be fixed in the next revision.<BR>
