...
- In the Rev V.1.3, It is known that the Grappler Minus card does not work with MFA2 WorkShop's WDrive due to timing issues. This is because there was a router error in one place, but it can be easily fixed. In addition, it works normally with SPIISD. This has been fixed in [V.1.4](GERBER_GH_DIY)<BR>
